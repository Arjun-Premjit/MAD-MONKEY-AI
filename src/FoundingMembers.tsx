    ...
    <div className="min-h-screen w-full relative overflow-x-hidden" style={{ background: "#ffffff" }}>
      ...
      <main className="relative z-10 w-full max-w-5xl mx-auto px-4 pb-24 pt-32 flex flex-col items-center">
        ...
        <div className="text-center mb-16" style={{ animation: "fadeInUp 0.5s ease-out both" }}>
          ...
          <p className="text-black font-bold text-xl">The visionaries behind Spark.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full">
          {/* Member Card Placeholder */}
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} style={{...glass.card, animation: `fadeInUp 0.5s ease-out ${i * 0.1}s both`}} className="p-8 flex flex-col items-center text-center">
              <div className="w-24 h-24 rounded-full bg-black/5 mb-6 border border-black/10 overflow-hidden flex items-center justify-center">
              ...
              <p className="text-black/60 font-medium text-sm mb-4">Co-Founder & Role</p>
              <p className="text-black/40 text-sm leading-relaxed">
                A brief description of the founding member's background and contribution to building the next generation of founders.
              </p>
            </div>
          ))}
        </div>
